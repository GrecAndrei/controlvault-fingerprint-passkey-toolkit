...
This checkout includes a tested Latitude 7400 TPM-backed deployment profile in
[`laptop/`](laptop/README.md). It keeps the upstream protocol implementation
and adds reproducible permissions, service hardening, and local configuration.
